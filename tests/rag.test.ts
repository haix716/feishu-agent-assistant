...
describe("searchImages", () => {
  before(() => {
    ...
    fs.writeFileSync(
      path.join(testDir, "20260602", "20260602120000_粉色兔子钥匙扣.jpg"),
      "",
    );
    fs.writeFileSync(
      path.join(
        testDir,
        "20260603",
        "20260603100000_长耳兔子毛绒玩具钥匙扣.jpg",
      ),
      "",
    );
    fs.writeFileSync(
      path.join(
        testDir,
        "20260603",
        "20260603110000_可爱卡通长耳朵兔子挂件.jpg",
      ),
      "",
    );
    fs.writeFileSync(
      path.join(testDir, "20260603", "20260603120000_猫咪抱枕.png"),
      "",
    );
